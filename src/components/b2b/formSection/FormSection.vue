...
const cidades = ref([
        { id: "Arapoanga", name: "Arapoanga" },
        { id: "Arniqueira", name: "Arniqueira" },
        { id: "Brazlândia", name: "Brazlandia" },
        { id: "Candangolândia", name: "Candangolandia" },
        { id: "Ceilândia", name: "Ceilandia" },
        { id: "Cruzeiro", name: "Cruzeiro" },
        { id: "Cruzeiro Velho", name: "CruzeiroVelho" },
        { id: "Gama", name: "Gama" },
        { id: "Guará", name: "Guara" },
        { id: "Itapoã", name: "Itapoa" },
        { id: "Jardim Botânico", name: "JardimBotanico" },
        { id: "Lago Norte", name: "LagoNorte" },
        { id: "Lago Sul", name: "LagoSul" },
        { id: "Noroeste", name: "Noroeste" },
        { id: "Núcleo Bandeirante", name: "NucleoBandeirante" },
        { id: "Paranoá", name: "Paranoa" },
        { id: "Park Way", name: "ParkWay" },
        { id: "Planaltina", name: "Planaltina" },
        { id: "Plano Piloto", name: "PlanoPiloto" },
        { id: "Polo de Modas Guará", name: "PolodeModas" },
        { id: "Pôr do Sol", name: "PorDoSol" },
        { id: "Recanto das Emas", name: "RecantodasEmas" },
        { id: "Riacho Fundo I", name: "RiachoFundo1" },
        { id: "Riacho Fundo II", name: "RiachoFundo2" },
        { id: "SAAN", name: "SAAN" },
        { id: "Samambaia", name: "Samambaia" },
        { id: "Santa Maria", name: "SantaMaria" },
        { id: "São Sebastião", name: "SaoSebastiao" },
        { id: "SIA", name: "SIA" },
        { id: "Sobradinho I", name: "Sobradinho1" },
        { id: "Sobradinho II", name: "Sobradinho2" },
        { id: "SOF SUL", name: "SOFSUL" },
        { id: "Sol Nascente", name: "SolNascente" },
        { id: "Taguatinga", name: "Taguatinga" },
        { id: "Taquari", name: "Taquari" },
        { id: "Varjão", name: "Varjao" },
        { id: "Vicente Pires", name: "VicentePires" },
]);
