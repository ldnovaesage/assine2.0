<template>
  <div class="w-screen flex flex-col bg-gray-100">
    <div class="flex flex-row justify-center items-center py-5">
      <div class="relative bg-white py-2 px-4 shadow-lg tooltip mr-4">
        <span
          class="text-age-business-blue-400 font-semibold"
      ...
      <div
        class="inline-flex justify-center items-center p-1 space-x-2 bg-age-business-blue-50 rounded-lg"
      >
        <button
          ...
          class="py-4 px-10 text-xs font-semibold transition-colors duration-300"
          style="font-size: 0.7em"
        >
          Link
        </button>
        <button
          ...
          class="py-4 px-10 text-age-business-blue-400 text-xs font-semibold transition-colors duration-300"
          style="font-size: 0.7em"
        >
          Banda
        </button>
    ...
    >
      <div class="flex flex-row items-center justify-center">
        <div class="-mr-12 z-50">
          <button @click="prevCard" class="bg-blue-700 rounded-full">
            <img
              class="px-2 w-12 h-12 rotate-180"
              src="@/assets/b2b/mobile/seta.svg"
              alt=""
            />
          </button>
        </div>
        <div
          class="flex flex-row justify-center items-start py-8 px-4 space-x-6"
        >
          <div
            v-for="link in filteredLinkPlans"
            :key="link.id"
            class="rounded-2xl"
            :class="{
        ...
        <div class="-ml-12 z-50 ">
          <button @click="nextCard" class="bg-blue-700 rounded-full">
            <img
              class="px-2 w-12 h-12"
              src="@/assets/b2b/mobile/seta.svg"
              alt=""
            />
          </button>
    ...
    <div
      ...
      class="flex flex-col justify-center items-center"
    >
      <div class="flex flex-row justify-center items-center py-8 px-4">
        <div class="-mr-12 z-50">
          <button @click="prevBand" class="bg-blue-700 rounded-full">
            <img
              class="px-2 w-12 h-12 rotate-180"
              src="@/assets/b2b/mobile/seta.svg"
              alt=""
        ...
        <div
          v-for="band in filteredBandaPlans"
          :key="band.id"
          class="rounded-2xl "
          :class="{
        ...
        <div class="-ml-12 z-50">
          <button @click="nextBand" class="bg-blue-700 rounded-full">
            <img
              class="px-2 w-12 h-12"
              src="@/assets/b2b/mobile/seta.svg"
              alt=""
...
const selectedCard = ref(linkPlans.value[0].id);

const filteredLinkPlans = computed(() => {
  return linkPlans.value.filter((link) => link.id === selectedCard.value);
});

const prevCard = () => {
  const currentIndex = linkPlans.value.findIndex(
    (link) => link.id === selectedCard.value
  );
  const prevIndex =
    (currentIndex - 1 + linkPlans.value.length) % linkPlans.value.length;
  selectedCard.value = linkPlans.value[prevIndex].id;
};
...
const nextCard = () => {
  ...
  const nextIndex = (currentIndex + 1) % linkPlans.value.length;
  selectedCard.value = linkPlans.value[nextIndex].id;
};
...
const selectedBand = ref(bandaPlans.value[0].id);

const filteredBandaPlans = computed(() => {
  return bandaPlans.value.filter((band) => band.id === selectedBand.value);
});

const prevBand = () => {
  const currentIndex = bandaPlans.value.findIndex(
    (band) => band.id === selectedBand.value
  );
  const prevIndex =
    (currentIndex - 1 + bandaPlans.value.length) % bandaPlans.value.length;
  selectedBand.value = bandaPlans.value[prevIndex].id;
};
...
const nextBand = () => {
  ...
  const nextIndex = (currentIndex + 1) % bandaPlans.value.length;
  selectedBand.value = bandaPlans.value[nextIndex].id;
};
</script>
