<template>
    <div>
      <div class="bg-age-business-blue-400 flex flex-col py-12">
        <span class="text-age-business-blue-100 text-xl font-bold"
      ...
      >
        <div class="flex flex-col w-full items-center justify-center p-12 space-y-8">
          <div class="">
            <img src="@/assets/b2b/AgeLogo.png" alt="" />
          </div>
          <div class="flex flex-col">
            <span
              class="text-age-business-blue-400 font-bold text-lg"
              style="letter-spacing: 0.5em"
              >FALE CONOSCO</span
            >
            <span class="text-white font-bold text-4xl">0800 2020 777</span>
          </div>
